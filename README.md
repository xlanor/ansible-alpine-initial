This is a personal fork of [chriswayg](https://github.com/chriswayg/ansible-initial-server)'s repo, stripped down to alpine images only and customised for my own use.
